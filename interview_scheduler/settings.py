# interview_scheduler/settings.py
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'scheduling',  # Make sure your scheduling app is included here
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        # Removed authentication classes to allow unauthenticated access
    ],
